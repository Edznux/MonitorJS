...
monitor = {
    ...
    cpu: {
        uptime: function cpuUptime(callback) {
           callback({success : true, data :os.uptime()});
        },
        load: function cpuLoad(callback) {
            callback({success : true, data :cpu(5)}); // over 5 last seconds
        },
        stats: function cpuStats(callback) {
            callback({success : true, data :os.cpus()});
        },
    ...
    memory: {
        ...
        total: function memoryTotal(callback) {
            ...
            // });
            callback({success : true, data : os.totalmem()});
        },
        free: function memoryFree(callback) {
            callback({success : true, data : os.freemem()});
        },
        cached: function memoryCached(callback) {
            memory(function(err, data) {
                ...
                callback({success : true, data : data[2][1]});
            });
        },
        buffers: function memoryBuffers(callback) {
            memory(function(err, data) {
                ...
                callback({success : true, data : data[3][1]});
            });
        },
        active: function memoryActive(callback) {
            memory(function(err, data) {
                ...
                callback({success : true, data :data[4][1]});
            });
        },
        inactive: function memoryInactive(callback) {
            memory(function(err, data) {
                ...
                callback({success : true, data :data[5][1]});
            });
        }
    },
    os: {
        release: function osRelease(callback) {
            exec("cat /proc/sys/kernel/osrelease", function(err, stdout, stderr) {
                ...
                callback({success : true, data : ignoreNewLine(stdout)});
            });
        },
        ...
        architecture : function systemAchitecture(callback){
            callback({success : true, data : os.arch()});
        },
        type : function systemType(callback){
            callback({success : true, data : os.type()});
        }
    },
    network: {
        interfaces: function networkInterfaces(callback) {
            callback({success : true, data : os.networkInterfaces()});
        },
