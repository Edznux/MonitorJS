    ...
    memory: {
        ...
        cached: function memoryCached(callback) {
            memory(function(err, data) {
                ...
                callback(err, {success: true, data: parseInt(data[2][1])});
            });
        },
        buffers: function memoryBuffers(callback) {
            memory(function(err, data) {
                ...
                callback(err, {success: true, data: parseInt(data[3][1])});
            });
        },
        active: function memoryActive(callback) {
            memory(function(err, data) {
                ...
                callback(err, {success: true, data: parseInt(data[4][1])});
            });
        },
        inactive: function memoryInactive(callback) {
            memory(function(err, data) {
                ...
                callback(err, {success: true, data: parseInt(data[5][1])});
            });
        }
    },
    os: {
